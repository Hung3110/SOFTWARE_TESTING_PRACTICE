...
3. [Chapter 1: Testing Principles](#chapter-1-testing-principles)
4. [Chapter 2: Testing Process](#chapter-2-testing-process)
5. [Chapter 3: Updating...](#chapter-3-updating)
...
Goal
JUnit 5 tests for `StudentAnalyzer` (excellent count, valid average) with boundary handling.
Techniques
